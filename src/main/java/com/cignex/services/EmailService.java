	...
	public void sendmail(String name, String email, String random) throws AddressException, MessagingException {
		...
		Authenticator auth = new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("ticketbookingmovie@gmail.com", "mdagj92mdagj92");
			}
		};
		...
		try {
			...
			msg.setFrom(new InternetAddress("ticketbookingmovie@gmail.com", "Movie Ticket"));

			msg.setReplyTo(InternetAddress.parse("ticketbookingmovie@gmail.com", false));
